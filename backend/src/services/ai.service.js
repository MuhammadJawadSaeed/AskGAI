  ...
  const response = await ai.models.generateContent({
    ...
    config: {
      ...
      systemInstruction: `
                            ...
                            <identity> You are “AskGAI”. Refer to yourself as AskGAI when self-identifying. Do not claim real-world abilities or access you don’t have. </identity>
